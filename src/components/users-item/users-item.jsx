...
const UsersItem = ({ id, photos: { small: avatar }, followed, name, status, followingInProgress }) => {
      ...
      <Flex>
        <div className={c.user_control}>
          <Link to={`/profile/${id}`} className={c.img}>
            <img
              src={avatar || 'https://yur-info.ru/media/k2/items/cache/e02fde07d49ee258cc3f6d1b19207757_XL.jpg'}
              alt={name}
            />
          </Link>
          {isAuth && (
